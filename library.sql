...
# Database: test3
# Generation Time: 2018-05-07 22:30:38 +0000
# ************************************************************
...
VALUES
	(1,'9781408855652 ','Harry Potter and the Philosopher\'s Stone','Bloomsbury Publishing PLC',2014,0,0,1,'Illustrated',0,9.35,1,4,3),
	...
	(5,'9780261103580','The Two Towers - The Lord of the Rings 2 ','HarperCollins Publishers ',2011,0,0,0,'6th edition',0,0.00,2,1,4);
...
INSERT INTO `borrowed_items` (`id`, `date_out`, `date_due`, `date_in`, `books_id`, `borrower_id`)
VALUES
	(1,'2018-01-01','2018-02-01',NULL,4,1);
...
INSERT INTO `borrowers` (`id`, `username`, `password`, `first_name`, `last_name`, `email`, `address`, `tel`, `acc_last_active`, `is_active`, `date_of_birth`)
VALUES
	(1,'kaa','kaa','Khadija','Abdul Rahman','khadija.a13@gmail.com','aasd',123,'2018-05-04',0,'1990-09-02');
